...
To become an active validator, you'll need a certain number of tokens for staking. Please refer to the [Faucet guide](/docs/get-started/new-user-guide/faucet.md) on obtaining test AVL tokens.
