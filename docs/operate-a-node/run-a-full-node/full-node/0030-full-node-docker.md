---
id: docker
title: Docker ile Full Node Çalıştırma
sidebar_label: Docker Kullanma
sidebar_position: 2
description: 'Bu adım adım kılavuz, Docker kullanarak bir Avail Full Node kurma ve çalıştırma sürecinde size yol gösterecektir.'
keywords:
  - docs
  - avail
  - node
...
**Ensure that you meet the [<ins>system requirements</ins>](/docs/operate-a-node/run-a-full-node/requirements.md).** We recommend downloading the pre-compiled binary for speed and convenience.
