---
id: 0010-light-client
title: Avail Hafif İstemcisi Nasıl Çalıştırılır?
sidebar_label: Light Client Çalıştırın
sidebar_position: 2
description: 'Avail Hafif İstemcinin nasıl çalıştırılacağını öğrenin.'
keywords:
  - docs
  - avail
  - node
...
We provide an Avail light client relay node that can help you with running your light client from behing NAT and firewalls. Find more information on running a relay node [<ins>here</ins>](docs/operate-a-node/run-a-full-node/0060-relay-node.md).

### Run a Full Node

Consider running a full node by following the deployment guide [<ins>here</ins>](/docs/operate-a-node/run-a-full-node/full-node/0020-full-node-binaries.md).